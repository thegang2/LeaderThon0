...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/thegang2/LeaderThon0.git"
    )
    ...
    TIME_leD = os.environ.get("TIME_leD", None)
    ...
    PMPERMIT_TEXT_leaderthon = os.environ.get("PMPERMIT_TEXT_leaderthon", None)
    UB_BLACK_LIST_CHAT = {
    ...
    # specify NO_LOAD with plugin names for not loading in leaderthon
