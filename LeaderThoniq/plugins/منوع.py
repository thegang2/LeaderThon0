...
@leaderthoniq.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@leaderthoniq.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
R = [
    ...
    "**-** قناة السورس **⪼ [𐇮 الجوكري ](t.me/leaderthon)   "
]

@leaderthoniq.on(admin_cmd(pattern="بلي$"))
...
@leaderthoniq.on(admin_cmd(pattern="اذكار$"))
async def ithker(knopis):
...
@leaderthoniq.on(admin_cmd(pattern="كت$"))
async def ithker(knopis):
...
leaderthon_5erok = [
    ...
    " لو خيروك |  بين البقاء مع مطور كايدو شهر أو بقاء مع المطور كايدو",
...
@leaderthoniq.on(admin_cmd(pattern="خيروك$"))
async def ithker(knopis):
    await knopis.edit(choice(leaderthon_5erok))

    
@leaderthoniq.on(admin_cmd(pattern="اذكار عشر$"))    
...
@leaderthoniq.on(admin_cmd(pattern="شنو رأيك بهذا$"))
async def ithker(knopis):
    await knopis.edit(choice(leaderthon_Shnow))
...
@leaderthoniq.on(admin_cmd(pattern="بوسة$"))
async def ithker(knopis):
    await knopis.edit(choice(leaderthon_Bosa))
