#ترجمه فريق ليدرثون  على التيلكرام
import json

import requests
#ترجمه فريق ليدرثون  على التيلكرام
from ..sql_helper.globals import gvarstatus
from . import leaderthoniq, edit_delete, edit_or_reply
...
async def get_adzan(adzan):
    ...
    leaderthoniqresult = f"<b>اوقـات صـلاه المـسلمين 👳‍♂️ </b>\
    ...
    "
    await edit_or_reply(adzan, leaderthoniqresult, "html")
