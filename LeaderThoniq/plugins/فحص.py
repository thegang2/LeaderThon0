...
from leaderthon import StartTime, leaderthoniq, JEPVERSION
...
@leaderthoniq.on(admin_cmd(pattern=f"{ALIVE_ET}(?:\s|$)([\s\S]*)"))
...
async def amireallyalive(event):
    ...
    leaderthoniq_caption = gvarstatus("ALIVE_TEMPLATE") or temp
    caption = leaderthoniq_caption.format(
