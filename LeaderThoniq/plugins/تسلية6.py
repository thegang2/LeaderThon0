...
@leaderthoniq.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular leaderthon",
    },
)
...
@leaderthoniq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular leaderthon",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@leaderthoniq.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna leaderthon is One of the Popular leaderthon",
    },
)
async def nekobot(cat):
...
@leaderthoniq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; leaderthon is One of the Popular leaderthon",
    },
)
async def nekobot(cat):
