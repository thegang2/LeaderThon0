...
from . import leaderthoniq, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m leaderthon`",
        "**State changed from starting to up**",
        "__INFO:leaderthon:Logged in as 557667062__",
        "__INFO:leaderthon:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
