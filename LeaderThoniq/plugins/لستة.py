...
from . import leaderthoniq, edit_delete, reply_id
...
@leaderthoniq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}لستة قنواتي الرسمية [𝗧ُِٔ𝗢ٍَِ𝗢َِّ𝗟َٖ𝗦َ]<buttonurl:t.me/leaderthon> [𝗝ََِ𝗠ٓ𝗧َُِْٓ𝗛ُ𝗢َ𝗡ٍَ]<buttonurl:t.me/leaderthon> ",
    },
)
async def _(event):
