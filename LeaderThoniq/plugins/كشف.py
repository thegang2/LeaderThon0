...
async def fetch_info(replied_user, event):
    ...
    caption = "✛━━━━━━━━━━━━━✛\n"
    caption += f"<b> {LED_EM}╎الاسـم    ⇠ </b> {full_name}\n"
    caption += f"<b> {LED_EM}╎المعـرف  ⇠ </b> {username}\n"
    caption += f"<b> {LED_EM}╎الايـدي   ⇠ </b> <code>{user_id}</code>\n"
    caption += f"<b> {LED_EM}╎الرتبـــه  ⇠ {rotbat} </b>\n"
    caption += f"<b> {LED_EM}╎الصـور   ⇠ </b> {replied_user_profile_photos_count}\n"
    caption += f"<b> {LED_EM}╎الحساب ⇠ </b> "
    caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
    caption += f"\n<b> {LED_EM}╎البايـو    ⇠ </b> {user_bio} \n"
    caption += f"✛━━━━━━━━━━━━━✛"
...
@leaderthoniq.ar_cmd(pattern="ايدي(?: |$)(.*)",
