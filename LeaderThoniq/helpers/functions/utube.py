...
PATH = "./leaderthon/cache/ytsearch.json"
...
async def yt_search(leaderthon):
    try:
        leaderthon = urllib.parse.quote(leaderthon)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={leaderthon}"
        )
...
"""
async def yt_data(leaderthon):
    params = {"format": "json", "url": leaderthon}
