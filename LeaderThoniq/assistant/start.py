#    جميع الحقوق لمطوري سورس ليدرثون حصريا لهم فقط
#    اذا تخمط الملف اذك الحقوق وكاتبيه ومطوريه لا تحذف الحقوق وتصير فاشل 👍
#كتابة وتطوير كايدو لمريض نفسي
import asyncio
import io
import re
...
from LeaderThon import bot
from LeaderThon.sql_helper.blacklist_assistant import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)
from LeaderThon.sql_helper.botusers_sql import add_me_in_db, his_userid
from LeaderThon.sql_helper.idadder_sql import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/XxKaido"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/XxKaido")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "يم كايدو شرح تنصيب XxKaido@")],
                [Button.url("كروب المساعدة ❓", "https://t.me/LeaderThonSupport")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @LeaderThon", alert=True)
